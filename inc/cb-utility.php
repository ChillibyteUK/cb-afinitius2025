...
// disable RSS feeds
// function cb_disable_feed() {
//     wp_die( __( 'No feed available, please visit the <a href="'. esc_url( home_url( '/' ) ) .'">homepage</a>!' ) );
// }
   
// add_action('do_feed', 'cb_disable_feed', 1);
// add_action('do_feed_rdf', 'cb_disable_feed', 1);
// add_action('do_feed_rss', 'cb_disable_feed', 1);
// add_action('do_feed_rss2', 'cb_disable_feed', 1);
// add_action('do_feed_atom', 'cb_disable_feed', 1);
// add_action('do_feed_rss2_comments', 'cb_disable_feed', 1);
// add_action('do_feed_atom_comments', 'cb_disable_feed', 1);
